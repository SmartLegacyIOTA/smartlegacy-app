...
import { SharedBadge, BadgeSize, BadgeVariant } from '@/src/components/shared/shared-badge';
    ...
    return (
        ...
        >
            ...
            <View style={styles.deviceHeader}>
                <View style={[styles.deviceIconContainer, { backgroundColor: colors.iconBg }]}>
                    <Icon
            ...
            {/* Device Details */}
            <View style={[styles.deviceDetails, { backgroundColor: theme.colors.slSurfaceMuted }]}>
