...
export function SharedAvatar(props: SharedAvatarProps) {
    ...
    const { size = 'medium', backgroundColor, bgColor, accessibilityLabel, containerStyle } = props;
    ...
    const resolvedBgColor =
        backgroundColor || (bgColor ? theme.colors[bgColor] : theme.colors.slAccent);

    if (props.variant === 'icon') {
        const { iconName, iconColor, iconThemeColor } = props;
        const resolvedIconColor =
            iconColor || (iconThemeColor ? theme.colors[iconThemeColor] : theme.colors.white);
    ...
    const resolvedTextColor =
        textColor || (textThemeColor ? theme.colors[textThemeColor] : theme.colors.white);
