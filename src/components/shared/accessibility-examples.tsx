...
export function ButtonAccessibilityExamples() {
    return (
        <View style={styles.container}>
            ...
            <SharedButton
                onPress={() => {}}
                leftIcon={<Icon variant='material-community' name='check' size={20} color='#fff' />}
...
export function TextAccessibilityExamples() {
    return (
        <View style={styles.container}>
            ...
            <SharedText variant='caption' accessibilityLabel='Last updated 2 minutes ago'>
                2m ago
            </SharedText>

            {/* Status Information */}
            <SharedText variant='label' accessibilityLabel='Guardian status: verified and active'>
                Verified
            </SharedText>
        </View>
    );
...
export function TouchableAccessibilityExamples() {
    return (
        <View style={styles.container}>
            ...
            >
                <Icon variant='material-community' name='content-copy' size={20} color='#000' />
            </TouchableOpacity>
...
export function ListAccessibilityExamples() {
    ...
    return (
        <View accessible={true} accessibilityRole='list' accessibilityLabel='Recent activities'>
...
export function StateAccessibilityExamples() {
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <SharedText variant='body'>{isLoading ? 'Loading...' : 'Ready'}</SharedText>
            </View>
            ...
            >
                <SharedText variant='body'>{isSelected ? '✓' : '○'} Accept Terms</SharedText>
            </TouchableOpacity>
