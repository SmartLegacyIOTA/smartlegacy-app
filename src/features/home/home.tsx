...
import { iotaPing } from '@/src/iota/services/iota-health.service';

const Home = () => {
    const theme = useTheme();
    const { t } = useI18nService();
    const { handleNotificationPress, handleManageGuardian, handleLegacyRecovery } = useHome();
    useEffect(() => {
        iotaPing()
            .then(r => console.log('IOTA OK', r))
            .catch(e => console.error('IOTA FAIL', e));
    }, []);
