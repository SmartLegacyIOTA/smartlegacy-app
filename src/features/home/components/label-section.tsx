...
export function LabelSection({ iconName, label, tagText, color, lightColor }: LabelSectionProps) {
    return (
        <View style={styles.container}>
            <Icon variant='material-community' name={iconName} size={14} color={color} />
            <SharedText
                variant='label'
            ...
            <View style={[styles.tag, { backgroundColor: lightColor }]}>
                <SharedText variant='label' style={{ fontSize: 9, fontWeight: '600', color }}>
                    {tagText}
                </SharedText>
            </View>
        </View>
